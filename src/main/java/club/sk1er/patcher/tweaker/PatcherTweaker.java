...
public class PatcherTweaker implements IFMLLoadingPlugin {
  ...
  public PatcherTweaker() {
    ...
    try {
      ...
      loadCoreMod.invoke(
          null, classLoader, "club.sk1er.patcher.tweaker.optifine.OptifinePatcherTweaker", mod);
    } catch (Exception e) {
  ...
  public String[] getASMTransformerClass() {
    ...
    if (ModCoreInstaller.isIsRunningModCore()) {
      return new String[] {
        "club.sk1er.mods.core.forge.ClassTransformer", ClassTransformer.class.getName()
      };
    }
