...
public class ScreenShotHelperTransformer implements PatcherTransformer {
    ...
    public void transform(ClassNode classNode, String name) {
        for (MethodNode methodNode : classNode.methods) {
            ...
            if ((methodName.equals("saveScreenshot") || methodName.equals("func_148259_a")) && methodDesc.equals("(Ljava/io/File;Ljava/lang/String;IILnet/minecraft/client/shader/Framebuffer;)Lnet/minecraft/util/IChatComponent;")) {
