...
public class EntityDiggingFXTransformer implements PatcherTransformer {
    /**
    ...
    public String[] getClassName() {
        return new String[]{"net.minecraft.client.particle.EntityDiggingFX"};
    }
    ...
    private InsnList cancelAnimation() {
