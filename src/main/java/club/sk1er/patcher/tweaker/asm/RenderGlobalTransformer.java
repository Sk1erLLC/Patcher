...
public class RenderGlobalTransformer implements PatcherTransformer {
    ...
    public void transform(ClassNode classNode, String name) {
        for (MethodNode methodNode : classNode.methods) {
            ...
            } else if (methodName.equals("setWorldAndLoadRenderers") || methodName.equals("func_72732_a")) {
                methodNode.instructions.insertBefore(methodNode.instructions.getLast().getPrevious(), fixResourceLeak());
            }
        }
    }
