...
public class ServerListTransformer implements PatcherTransformer {
    ...
    private InsnList func_147413_aClean(MethodNode methodNode) {
        ...
        list.add(new FieldInsnNode(Opcodes.GETFIELD, "net/minecraft/client/multiplayer/ServerList", "servers", "Ljava/util/List;"));
        ...
        list.add(new VarInsnNode(Opcodes.ALOAD, 0));
        list.add(new FieldInsnNode(Opcodes.GETFIELD, "net/minecraft/client/multiplayer/ServerList", "logger", "Lorg/apache/logging/log4j/Logger;"));
    ...
    private InsnList swapCleanServers(MethodNode methodNode) {
        ...
        list.add(new VarInsnNode(Opcodes.ALOAD, 0));
        list.add(new VarInsnNode(Opcodes.ILOAD, 1));
        list.add(new MethodInsnNode(Opcodes.INVOKESPECIAL, "net/minecraft/client/multiplayer/ServerList", "getServerData",
        ...
        list.add(new InsnNode(Opcodes.POP));
        list.add(new VarInsnNode(Opcodes.ALOAD, 0));
        list.add(new MethodInsnNode(Opcodes.INVOKESPECIAL, "net/minecraft/client/multiplayer/ServerList", "saveServerList", "()V", false));
        list.add(l1);
