        ...
        while (iterator.hasNext()) {
            ...
            if (node.getOpcode() == Opcodes.INVOKEVIRTUAL) {
                ...
                if (nodeName.equals("drawString") || nodeName.equals("func_78276_b")) {
                    methodNode.instructions.set(node, new MethodInsnNode(Opcodes.INVOKESTATIC, "club/sk1er/patcher/hooks/NameTagRenderingHooks", "drawNametagText", "(Lnet/minecraft/client/gui/FontRenderer;Ljava/lang/String;III)I", false));
//                    break;
                }
            }
        }
