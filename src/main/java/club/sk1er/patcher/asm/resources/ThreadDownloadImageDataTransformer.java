...
public class ThreadDownloadImageDataTransformer implements PatcherTransformer {
    ...
    private InsnList getImprovedCacheLoading() {
        ...
        list.add(new MethodInsnNode(Opcodes.INVOKESTATIC, getHookClass("ThreadDownloadImageDataHook"), "getImprovedCacheLoading", "(Lnet/minecraft/client/renderer/ThreadDownloadImageData;)V", false));
